        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bunkrupt = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Planet = table.Column<string>(type: "nvarchar(130)", maxLength: 130, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PilotLicenseType = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrequentFlyer = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Departure = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValueSql: "(N'(not set)')"),
                    Destination = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValueSql: "(N'(not set)')"),
                    ...
                    FreeSeats = table.Column<short>(type: "smallint", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: true, defaultValueSql: "((123.45))"),
                    Memo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Strikebound = table.Column<bool>(type: "bit", nullable: true),
                    Utilization = table.Column<decimal>(type: "numeric(20,8)", nullable: true, computedColumnSql: "((100.0)-(([FreeSeats]*(1.0))/[Seats])*(100.0))", stored: false),
